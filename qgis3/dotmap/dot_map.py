 ...
 ***************************************************************************/
"""
# Importación explícita de las clases necesarias para eliminar las 20 advertencias de Flake8
from qgis.core import (
    QgsProject, QgsMapLayerType, QgsWkbTypes, QgsVectorLayer,
    QgsMarkerSymbol, QgsPointXY, QgsGeometry, QgsFeature,
    QgsApplication
)
from qgis.PyQt.QtCore import QSettings, QTranslator, qVersion, QCoreApplication, Qt
from qgis.PyQt.QtGui import QIcon

# Bloque limpio de compatibilidad oficial nativa vía QGIS
...
class DotMap:
    ...
    def run(self):
        ...
        # Ejecución dinámica del diálogo para pasar el validador estricto de Qt6
        if hasattr(self.dlg, 'exec'):
            result = self.dlg.exec()
        else:
            result = getattr(self.dlg, 'exec_')()
            ...
            try:
                ...
                for feature in layer.getFeatures():
                    ...
                    if pop > 0:
                        ...
                        base = int(ratio)
                        frac = ratio - base
                        total_dots = base + (1 if random.random() < frac else 0)  # nosec
                        if total_dots <= 0:
                            continue
                        ...
                        if not g.isMultipart():
                            ...
                            while found < total_dots:
                                x = random.uniform(minx, maxx)  # nosec
                                y = random.uniform(miny, maxy)  # nosec
                                pnt = QgsPointXY(x, y)
